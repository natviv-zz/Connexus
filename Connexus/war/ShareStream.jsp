...
<script>
  ...
  window.fbAsyncInit = function() {
    FB.init({
      appId      : 506689359421955, // App ID
      channelUrl : 'http://natviv.appsot.com/channel.html', // Channel File
...
<div class="page secondary fixed-header">
    ...
    <div class="page-region">
       ...
       <%
        ...
        function redirect()
        {
        window.location.assign("http://natviv.appspot.com/ViewStreamFB.jsp")
        }
        </script>
        ...
        <div class="tile double bg-color-darken image-slider" data-role="tile-slider" data-param-period="5000" data-param-direction="left">
                    <div class="tile-content bg-color-darken">
                        <div class="fb-login-button" data-width="400" size="xlarge" onlogin="redirect();"></div>
                    </div>
