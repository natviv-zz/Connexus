    ...
    <div class="page-region">
       ...
       <div class= "form">
            <div class="container">
                  ...
                  <form id="signup" name="TrendingFormServlet" action="TrendingFormServlet" method="get">

                  <div class="header">
        
                  <h3>If TA get Trending Stream report</h3>
            ...
            <div class="sep"></div>
                     ...
                     <input type="radio" name="cronfrequency" value="0" /> None<br/>
                     <input type="radio" name="cronfrequency" value="1" /> Once every 5 minutes<br/>
                     <input type="radio" name="cronfrequency" value="2" checked /> Once every hour<br/>
                     <input type="radio" name="cronfrequency" value="3" /> Once every day<br/>
