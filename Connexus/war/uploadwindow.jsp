...
<head>
    ...
    <script src="http://hayageek.com/docs/extra/jquery.uploadfile.js"></script>
    ...
    <div class="page-region">
       ...
       <%
		...
		%>
                  ...
                  <form id="sign" name="UploadImg" action="<%= blobstoreService.createUploadUrl("/upload") %>" method="post" enctype="multipart/form-data">
                   ...
                   <div id="fileuploader" style="display: none; width: 1%">Upload</div>
