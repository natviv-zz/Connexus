    ...
    <div class="page-region">
       ...
       <div class= "form">
            <div class="container">
                  ...
                  <form id="signup" name="createStream" action="createStreamServlet" method="get">
            ...
            <div class="sep"></div>
                   ...
                   <div class="inputs">
                     ...
                     <input type="text" name="streamName" placeholder="Stream name"  autofocus /><br/>
        
                     <input type="text" name="tags" placeholder="Add hash tags" /><br/>
                     
                     <input type="url" name="url" placeholder="Cover Image URL" autofocus/><br/>
            
                     <input type="hidden" name="user" value="<%=email%>" />
            
                    <input type="submit" id="submit" value="Create Stream" />
