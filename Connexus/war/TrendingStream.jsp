    ...
    <div class="page-region">
       ...
       <%
		...
		for (Stream s : th ) {
		  ...
		  System.out.println("s = " + s + " Viewcount =" +s.viewcount);
		    ...
		    // the line below is useful when debugging (jsp or servlet)
              ...
              System.out.println(" First= "+ s.name );
              firstname=s.name;
		  ...
		  <div class="tile double bg-color-darken image-slider" data-role="tile-slider" data-param-period="5000" data-param-direction="left">
                    ...
                    <div class="tile-content bg-color-darken">
                        <div class="brand">            
                         <div class="name"><a href="TrendingReportForm.jsp"> If TA click here to get trending stream report</a></div>
                    </div>
                    </div>
                    <div class="tile-content">
		    ...
		    // the line below is useful when debugging (jsp or servlet)
              ...
              System.out.println(" Second= "+ s.name );
              secondname=s.name;
		  ...
		  <div class="tile double bg-color-darken image-slider" data-role="tile-slider" data-param-period="5000" data-param-direction="left">
		    ...
		    // the line below is useful when debugging (jsp or servlet)
              ...
              System.out.println(" Third= "+ s.name );
