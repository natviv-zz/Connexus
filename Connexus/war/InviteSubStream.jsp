    ...
    <div class="page-region">
       ...
       <%
        ...
        if (user != null) {
                          ...
                          System.out.println("Invite subscriber for stream" +streamName+ "by"+ nickname);
        %>           
       ...
       <div class= "form">
            <div class="container">
                  ...
                  <form id="signup" name="InviteSubscribers" action="EmailSubServlet" method="get">
            ...
            <div class="sep"></div>
                   ...
                   <div class="inputs">
                     ...
                     <input type="email" name="email" placeholder="Enter subscriber email id"  autofocus /><br/>
                     
                     <input type="hidden" name="streamname" value=<%=streamName%>  autofocus /><br/>
                     
                     <input type="hidden" name="nickname" value=<%=nickname%>  autofocus /><br/>
