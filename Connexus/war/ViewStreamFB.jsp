       ...
       <%
        ...
        <div class="tile double bg-color-darken image-slider" data-role="tile-slider" data-param-period="5000" data-param-direction="left">
                    <div class="tile-content bg-color-darken">
                        <h3>Congratulations! You are logged in with Facebook. To share a stream click on Facebook icon at the bottom of the page </h3>
                    </div>
                    <div class="tile-content bg-color-darken">
                        <div class="brand">         
                        <div class="name"><a href="ViewStream.jsp">Click here to view streams</a></div>
                    </div>
                    </div>
