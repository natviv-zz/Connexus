    ...
    <div class="page-region">
       ...
       <%
		...
		for (Stream s : th ) {
		  ...
		  if(s.owner.equals(email))
		  {
		  System.out.println("Owned " + s.name);
		  ...
		  <div class="tile double bg-color-darken image-slider" data-role="tile-slider" data-param-period="5000" data-param-direction="left">
                    <div class="tile-content">
                        ...
                        <div class="name"><a href="ShowaStream.jsp?streamId=<%= s.id %>&streamName=<%= s.name %>"> <%= s.name %>  <%= s.createDate %></a></div>
                    </div>
                    </div>
                    <div class="tile-content">
                    ...
                    <div class="tile-content bg-color-darken">
                        <div class="brand">            
                         <div class="name"><%= s.name %> <%=s.viewcount %> views in the last hour</div>
                    </div>
                    </div>
                    <div class="tile-content bg-color-darken">
                        <div class="brand">            
                         <div class="name"><%= s.name %> <%=s.pviewcount %> views since created</div>
                    </div>
                    </div>
                    <div class="tile-content bg-color-green">
                        <div class="brand">
                        
                        <div class="name"><a href="/delete?d=<%="1" %>&streamName=<%= s.name %>&email=<%=email%>"> Click here to delete stream </a></div>
                    </div>
                    </div>
                    <div class="tile-content">
                        <div class="brand">
                        
                        <div class="name"><a href="InviteSubStream.jsp?streamname=<%= s.name %>"> Click here to invite subscribers to Stream</a></div>
                    </div>
                    </div>
                    <div class="tile-content">
                        <div class="brand">
                        
                        <div class="name"><a href="EditCoverURL.jsp"> Click here to edit cover url for a stream</a></div>
                    </div>
                    </div>
