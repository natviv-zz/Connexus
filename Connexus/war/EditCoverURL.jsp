    ...
    <div class="page-region">
       ...
       <div class= "form">
            <div class="container">
                  ...
                  <form id="signup" name="Edit URL" action="EditCoverServlet" method="get">

                  <div class="header">
        
                  <h3>Edit Cover URL</h3>
            ...
            <div class="sep"></div>
                   ...
                   <div class="inputs">
                     ...
                     <input type="url" name="url" placeholder="Give new cover URL"  autofocus /><br/>
        
                     
            
                    
            
                    <input type="submit" id="submit" value="Edit URL" />
