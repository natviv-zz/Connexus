       ...
       <%
        ...
        <div class="tile double bg-color-darken image-slider" data-role="tile-slider" data-param-period="5000" data-param-direction="left">
                    <div class="tile-content bg-color-red">
                        ...
                        <div class="name"><a href="ViewOwnedStream.jsp">Error: You tried to create a Stream whose name is the same as an existing stream. Operation did not complete </a></div>
                   
                    </div>
                    <div class="tile-content bg-color-darken">
                        <div class="brand">         
                        <div class="name"><a href="CreateStream.jsp">Click here to try create a stream again</a></div>
                    </div>
                    </div>
