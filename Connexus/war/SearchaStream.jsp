...
<div class="page secondary fixed-header">
    ...
    <div class="page-region">
       ...
       <div class= "form">
                  ...
                  <form id="signup" name="searchStream" action="SearchStreamServlet" method="get">
            ...
            <div class="sep"></div>
                   ...
                   <div class="inputs">
                     ...
                     <input type="text" id="search" name="streamName" placeholder="Stream name"  autofocus /><br/>
        
                     
            
                    
            
                    <input type="submit" id="submit" value="Search Stream" />
                    
                    <input type="submit" id="submit" value="Rebuild Index" />
