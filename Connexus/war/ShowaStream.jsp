       ...
       <%
		...
		%>
		      ...
		      <div class="tile double bg-color-darken image-slider" data-role="tile-slider" data-param-period="5000" data-param-direction="left">
                    <div class="tile-content bg-color-darken">
                        <div class="brand">            
                         <div class="name"><%= streamName %></div>
                    </div>
                    </div>
		  ...
		  if (s.name.equals(streamName))
		     {
		        ...
		        System.out.println("Viewcount="+s.viewcount);
		        System.out.println("Permanent Viewcount="+s.pviewcount);
		        
		        System.out.println("Updated View Count="+ s.updateviewcount());
		        System.out.println("Updated View Count="+ s.pupdateviewcount());
		    ...
		    %>    
                      ...
                      {
                       var s="<%=streamId%>";
                       var url='Carousel.jsp?streamId='+s;
                       ...
                       <div class="tile-content bg-color-blue">
                          <div class="tile-content">
		                    <img src="https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQr8Gq9vyMPdL1qKvWqgAhiLBZCQBzXauwZtYeAUjEGg7ZFJj6l" alt="Cover Image not found">
                          </div>
                          
                          
                          <div class="brand">
                                     
                          <div class="name"><%= s.tags %></div>
                          </div>
              	       </div>
              	       <div class="tile-content bg-color-green">
                          <div class="brand">            
                          <div class="name"><%= s.createDate %></div>
                          </div>
              	       </div> 
              	       <div class="tile-content bg-color-purple">
                          <div class="brand">            
                          <div class="name">Created by <%= s.owner %></div>
                          </div>
              	       </div>
              	       
              	       <div class="tile-content bg-color-orange">
                          <div class="brand">            
                          <div class="name">Total views <%= s.pviewcount %></div>
                          </div>
              	       </div>  
              	         
		  
		                <div class="tile-content">
		                    <img src="<%= s.coverImageUrl %>" alt="Cover Image not found">
                       </div>
                       <div class="tile-content bg-color-green">
                        <div class="brand">
                        
                        <div class="name"><a href="/subscribe?streamName=<%= s.name %>&email=<%=email%>"> Click here to subscribe </a></div>
                    </div>
                    </div>
                       <div class="tile-content bg-color-magenta">
                        <div class="brand">
                        
                        <div class="name"><a href="UploadImgnew.jsp?streamId=<%= s.id %>&streamName=<%= s.name %>">Upload an Image to Stream <%= s.name %></a></div>
                    </div>
                    </div>
		  ...
		  %>
              ...
              <%      
		       ...
		       if ( img.streamId.equals(streamId) ) {
     		   ...
     		   %>
     		         <div class="tile-content" onclick="redirect()">
