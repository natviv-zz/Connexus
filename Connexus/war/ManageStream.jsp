       ...
       <%
        ...
        <div class="tile double bg-color-darken image-slider" data-role="tile-slider" data-param-period="5000" data-param-direction="left">
                    <div class="tile-content bg-color-purple">
                        <div class="brand">         
                        <div class="name"><a href="ViewOwnedStream.jsp">Click here to view owned streams</a></div>
                    </div>
                    </div>
                    <div class="tile-content bg-color-darken">
                        <div class="brand">         
                        <div class="name"><a href="ViewSubscribedStream.jsp">Click here to view subscribed streams</a></div>
                    </div>
                    </div>
